        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6 mb-4 mb-lg-0">
                ...
                <ul class="list-unstyled">
                    <li><a href="index.php" class="text-decoration-none" style="color: #0A0F24;">Accueil</a></li>
                    <li><a href="auteur.php" class="text-decoration-none" style="color: #0A0F24;">Auteurs</a></li>
                    <li><a href="document.php" class="text-decoration-none" style="color: #0A0F24;">Documents</a></li>
                </ul>
            </div>
            <!-- Section Contact -->
